...
class _BadgeDetalheState extends State<BadgeDetalhe> {
  ...
  if (raw is List) {
    // Convertemos de forma segura a lista dinâmica para a estrutura que o widget precisa
                                  ...
                                  children: [
                                    ...
                                    if (requisitos.isEmpty)
                                      ...
                                      ...requisitos.asMap().entries.map((entry) {
                                        ...
                                        // 🌟 Pega o Título para meter na bolinha amarela (se não houver, usa um fallback)
                                        final textoCirculo = req['titulo']?.toString() ?? '-';
                                        
                                        // 🌟 Pega o Nome do Requisito para meter à frente
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              children: [
                                                // Círculo Amarelo
                                                Container(
                                                  width: 32, // 💡 Aumentei ligeiramente de 28 para 32 para o título não cortar se for maiorzinho
                                                  height: 32,
                                                  ...
                                                  child: Center(
                                                    child: Text(
                                                      textoCirculo, // 🌟 Agora mostra o Título (ex: R1, T1 ou o que tiver na BD)
                                                      style: const TextStyle(
                                                        fontSize: 10,
                                                        fontWeight: FontWeight.bold,
                                                        color: Colors.white,
                                                ...
                                                Expanded(
                                                  child: Text(
                                                    textoFrente, // 🌟 Agora mostra o Nome do requisito ao invés da descrição
                                                    style: const TextStyle(
                                                      fontSize: 11,
                                                      fontWeight: FontWeight.w600,
                                                    ),
